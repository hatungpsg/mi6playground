...
# os.system('touch quartus.ini')
# Pre-release Quartus requires password 
os.system('echo PGM_ENABLE_MULTIPLE_FLASH=on >> quartus.ini')
...
# print("Rpd file ---> %s" %generated_file[2:])
# rpd_file = generated_file[2:]
...
def main():
    ...
    try:
        ...
        # JIC programming doesnot need this
        ...
        # Reset MSEL for ND5 RevB and ND4 RevA
